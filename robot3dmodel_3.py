...
class robot3d(QOpenGLWidget):
    ...
    def paintGL(self):
        ...
        glTranslatef(0.2, 0, -0.8)# 몸통을 평면으로 들어올리는 변환
        #glRotatef(self.yaw, 0, -1, 0)
        #glRotatef(self.roll, 0, 0, -1)# 몸통을 회전
        #glRotatef(self.pitch, -1, 0, 0)
...
#==================================================================
        ...
        glTranslatef(1.8, 0, -0.8) # 몸통을 평면으로 들어올리는 변환
        #glRotatef(self.yaw, 0, -1, 0)
        #glRotatef(self.roll, 0, 0, -1)# 몸통을 회전
        #glRotatef(self.pitch, -1, 0, 0)
...
#==================================================================
        ...
        glTranslatef(1.8, 0, 4.8) # 몸통을 평면으로 들어올리는 변환
        #glRotatef(self.yaw, 0, -1, 0)
        #glRotatef(self.roll, 0, 0, -1)# 몸통을 회전
        #glRotatef(self.pitch, -1, 0, 0)
...
#==================================================================
        ...
        glTranslatef(0.2, 0, 4.8) # 몸통을 평면으로 들어올리는 변환
        #glRotatef(self.yaw, 0, -1, 0)
        #glRotatef(self.roll, 0, 0, -1)# 몸통을 회전
        #glRotatef(self.pitch, -1, 0, 0)
